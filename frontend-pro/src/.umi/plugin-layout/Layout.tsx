...
/// <reference types="/root/.openclaw/workspace-vest/promo-data-analyzer/frontend-pro/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "/root/.openclaw/workspace-vest/promo-data-analyzer/frontend-pro/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const formatMessage = undefined;
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'promo-data-analyzer-frontend-pro'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
