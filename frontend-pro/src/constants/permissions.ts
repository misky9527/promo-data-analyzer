...
export const DEFAULT_ADMIN_PERMISSIONS = [...ALL_PERMISSIONS] as const;

export type PermissionKey = (typeof ALL_PERMISSIONS)[number];

export const DICT_PERMISSION_KEYS = PERMISSION_MENUS.dict.children.map((item) => item.key) as PermissionKey[];
